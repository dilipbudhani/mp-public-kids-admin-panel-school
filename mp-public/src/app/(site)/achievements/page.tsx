...
export default function AchievementsPage() {
    ...
    return (
        <main className="min-h-screen pb-20">
            ...
            <section
                data-hero-dark="true"
                className="relative h-[40vh] md:h-[50vh] flex items-center overflow-hidden bg-primary text-white"
            >
                ...
                <div className="container mx-auto relative z-10 text-left px-4 md:px-6">
                    <motion.h1
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.1 }}
                        className="text-4xl md:text-6xl font-extrabold mb-4 font-playfair"
                    >
