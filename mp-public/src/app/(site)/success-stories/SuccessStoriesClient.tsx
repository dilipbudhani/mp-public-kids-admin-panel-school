...
export default function SuccessStoriesClient({ initialStories, stats, pageData }: SuccessStoriesClientProps) {
    ...
    return (
        <main className="min-h-screen">
            ...
            <section
                data-hero-dark="true"
                className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 bg-primary overflow-hidden"
            >
                ...
                <div className="container relative z-10">
                    ...
                    >
                        <div className="flex items-center gap-3 text-gold mb-4">
                            ...
                            <span className="text-sm font-bold tracking-[0.3em] uppercase">{heroData.subtitle}</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-playfair font-bold text-white mb-6 leading-tight whitespace-pre-line">
                            {heroData.title}
                        </h1>
                    ...
                    <div className="bg-primary/5 rounded-[3rem] p-8 lg:p-20 relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-3xl">
                            ...
                            <p className="text-lg text-text/70 mb-10 leading-relaxed font-medium">
                                Join MP Public School and embark on a journey that identifies your strengths, nurtures your talents, and prepares you for global excellence.
                            </p>
