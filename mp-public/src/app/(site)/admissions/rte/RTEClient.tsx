...
const PROCESS_STEPS = [
    {
        ...
        desc: 'Visit the official Madhya Pradesh RTE portal and complete the online application form. Select MP Public School as your preferred school.',
                            ...
                            <div className="bg-primary rounded-3xl p-8 text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-white/80 text-sm leading-relaxed mb-6">
                                        <strong className="text-gold">MP Public School</strong> proudly reserves <strong className="text-gold">25% of Class 1 seats</strong> for economically weaker sections and disadvantaged groups, in full compliance with the RTE Act 2009.
                                    </p>
