...
export const metadata: Metadata = {
    title: 'School Gallery | MP Public School',
    description: 'Explore the vibrant campus life, events, sports, and academic achievements of MP Public School through our image and video gallery.',
};
    ...
    return (
        <main className="min-h-screen bg-surface">
            <PageHeader
                ...
                description={pageData?.description || "A visual journey through the vibrant life, achievements, and spirit of MP Public School."}
                dark={true}
            />
