...
export const metadata = {
    title: "Smart Classrooms | MP Public School",
            ...
            <div className="prose prose-slate max-w-none">
                ...
                {pageData?.sections?.[0] ? (
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        MP Public School believes that technology should be an enabler of pedagogy, not a replacement. Our smart classrooms are equipped with the latest audio-visual aids to make complex concepts intuitive and engaging.
                    </p>
                )}
