...
export const metadata = {
    title: "Science Laboratories | MP Public School",
            ...
            <div className="prose prose-slate max-w-none">
                ...
                {pageData?.content?.[0] ? (
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        The science labs at MP Public School are designed to meet international safety standards and are equipped with sophisticated equipment for Physics, Chemistry, and Biology. We encourage a culture of inquiry where students transition from theory to practice seamlessly.
                    </p>
                )}
