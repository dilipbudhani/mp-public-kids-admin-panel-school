...
export const metadata = {
    title: "School Library | MP Public School",
...
export default async function LibraryPage() {
    ...
    const pageData = await StaticPage.findOne({ slug: "library-facilities", schoolIds: process.env.SCHOOL_ID }).lean() as IStaticPage | null;
            ...
            <div className="prose prose-slate max-w-none">
                ...
                {pageData?.content?.[0] ? (
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        The library at MP Public School is more than just a room full of books. It is a modern resource center equipped with digital archives, quiet reading zones, and collaborative spaces designed to inspire scholarly pursuit.
                    </p>
                )}
