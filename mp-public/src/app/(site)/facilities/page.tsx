...
export const metadata = {
    title: "World-Class Facilities | MP Public School",
    description: "Explore the state-of-the-art infrastructure and facilities at MP Public School designed for holistic student development.",
};
...
export default async function FacilitiesOverview() {
    ...
    const coreContent = {
        ...
        description: pageData?.description || "MP Public School features a sprawling 15-acre campus with state-of-the-art infrastructure designed to foster academic, athletic, and creative growth.",
