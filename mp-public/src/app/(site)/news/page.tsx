...
export default async function NewsPage() {
    ...
    const description = pageData?.description || "Witness the vibrant life at MP Public School. From academic milestones to creative triumphs, stay connected with our evolving legacy.";
