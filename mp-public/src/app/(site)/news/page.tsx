...
export const metadata = {
    title: 'School News & Updates | MP Public School',
    description: 'Keep up with the latest happenings, achievements, and announcements from the MP Public School community.',
};

export default async function NewsPage() {
    await dbConnect();

    const newsData = await News.find({ isPublished: true, schoolIds: process.env.SCHOOL_ID })
        .sort({ date: -1 })
        .lean();
                ...
                <div className="container relative z-10 mx-auto px-4">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-lg text-slate-300 leading-relaxed font-inter max-w-2xl">
                            Witness the vibrant life at MP Public School. From academic milestones to creative triumphs, stay connected with our evolving legacy.
                        </p>
                    </div>
                </div>
            </section>
