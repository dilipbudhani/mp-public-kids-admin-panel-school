...
export function Footer({ settings }: { settings?: any }) {
    ...
    const schoolName = settings?.schoolName || "MP Public School";
    ...
    return (
        <footer className="bg-primary text-white pt-10 lg:pt-20 pb-10 border-t-4 border-gold print:hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-6 mb-16">
                    ...
                    <div className="flex flex-col gap-6 sm:col-span-2 lg:col-span-2">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {settings?.twitterUrl && <SocialIcon icon={<XIcon className="w-4 h-4 text-white" />} href={settings.twitterUrl} bgColor="bg-black border border-white/20" />}
                            {settings?.instagramUrl && <SocialIcon icon={<Instagram className="w-5 h-5" />} href={settings.instagramUrl} bgColor="bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600" />}
                            {settings?.youtubeUrl && <SocialIcon icon={<YoutubeIcon className="w-5 h-5 text-white" />} href={settings.youtubeUrl} bgColor="bg-red-600" />}
                        </div>
                    </div>
            ...
            {/* Bottom Bar */}
            <div className="bg-primary-dark/30 py-6 border-t border-white/5">
