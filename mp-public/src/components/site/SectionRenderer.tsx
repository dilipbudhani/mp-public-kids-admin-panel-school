    ...
    return (
        <section className={index % 2 === 0 ? "py-24 bg-white" : "py-24 bg-slate-50"}>
            <div className="container mx-auto px-4">
                <div className={section.image ? (index % 2 === 0 ? "flex flex-col lg:flex-row items-center gap-16" : "flex flex-col lg:flex-row-reverse items-center gap-16") : "w-full"}>
                    <div className={section.image ? "w-full lg:w-1/2" : "w-full mx-auto text-center"}>
                        {section.subheading && (
