...
export function AboutPreview({ data }: AboutPreviewProps) {
    ...
    const content = data?.content || "For over 25 years, MP Public School has been at the forefront of quality education. We combine traditional values with modern methodology to create a learning environment that is both rigorous and supportive.";
