...
async function main() {
    try {
        ...
        await Testimonial.insertMany([
            { name: "Suresh Gupta", role: "Parent", content: "The level of individual attention my child receives at MPKS is truly commendable.", rating: 5, isActive: true, displayOrder: 0 },
        ...
        await News.insertMany([
            { title: "CBSE Board Results 2026", slug: "cbse-board-results-2026", category: "Results", date: new Date(), summary: "MPKS students shine again with 100% result in Class 10th and 12th board exams.", content: "Full content about academic success...", imageUrl: "/images/news-1.jpg", isFeatured: true, isPublished: true },
        ...
        await SiteSettings.findOneAndUpdate(
            { _id: 'global' },
            {
                ...
                address: 'Airport Rd, Ashok Nagar, Indore, Madhya Pradesh - 452005, India',
