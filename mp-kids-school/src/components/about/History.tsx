...
const DEFAULT_TIMELINE = [
    {
        ...
        description: 'MP Kids School was established with a small cohort of 50 students and a vision for holistic growth.',
    },
    {
        year: '2005',
...
export default function SchoolHistory({
    ...
    legacyText = "A Legacy of Excellence Since 1995"
}: SchoolHistoryProps) {
    return (
