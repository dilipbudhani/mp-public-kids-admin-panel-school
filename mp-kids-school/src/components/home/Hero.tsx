...
export function Hero({ slides }: { slides: Slide[] }) {
    ...
    return (
        <section data-hero-dark="true" className="relative h-auto lg:h-[90vh] min-h-[600px] flex flex-col lg:flex-row lg:items-center overflow-x-hidden overflow-y-clip lg:overflow-hidden bg-primary pt-20 lg:pt-0">
            ...
            <div className="container relative z-10 flex flex-col justify-center h-full pt-16 pb-20 lg:py-0">
            ...
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 z-20 flex justify-between px-4 lg:px-12 pointer-events-none">
                <button
                    onClick={handlePrev}
                    className="p-4 rounded-2xl bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/20 transition-all active:scale-95 group pointer-events-auto"
                >
