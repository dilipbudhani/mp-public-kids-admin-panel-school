...
export async function POST(req: NextRequest) {
    try {
        ...
        const admission = await Admission.findOne({ _id: admissionId, schoolIds: 'mp-kids-school' });
        ...
        await Admission.findOneAndUpdate({ _id: admissionId, schoolIds: 'mp-kids-school' }, {
            $set: {
