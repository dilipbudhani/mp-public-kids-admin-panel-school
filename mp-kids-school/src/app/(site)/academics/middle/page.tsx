...
export default async function MiddleSchoolPage() {
    ...
    const pageData = await StaticPage.findOne({
        slug: "academics-middle",
        schoolIds: schoolId
    }).lean();

    const content = {
        title: pageData?.title || "Middle School",
        subtitle: pageData?.subtitle || "Encouraging critical thinking, scientific inquiry, and specialized learning for Classes 6 to 8.",
        bannerImage: pageData?.bannerImage || "/images/middle-hero.jpg"
    };
            ...
            <div className="prose max-w-none">
                {pageData?.sections && pageData.sections.length > 0 ? (
                    ...
                    <>
                        ...
                        <h3 className="text-2xl font-serif text-primary mb-6">Discovery-Based Learning</h3>
