...
export default async function PrimaryPage() {
    ...
    const content = {
        title: pageData?.title || "Primary Wing",
        subtitle: pageData?.subtitle || "Building a strong foundation in core subjects and essential life skills for Classes 1 to 5.",
        bannerImage: pageData?.bannerImage || "/images/primary-hero.jpg"
    };
