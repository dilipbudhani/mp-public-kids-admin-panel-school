...
export default async function SeniorSecondarySchoolPage() {
    await dbConnect();
    const schoolId = process.env.SCHOOL_ID || "mp-kids-school";
    ...
    const content = {
        title: pageData?.title || "Senior Secondary",
        subtitle: pageData?.subtitle || "Specialized stream-based education for Classes 11 and 12, fostering future leaders and innovators.",
        bannerImage: pageData?.bannerImage || "/images/senior-hero.jpg"
    };
                ...
                {pageData?.sections && pageData.sections.length > 0 ? (
                    ...
                    <>
                        ...
                        <p className="text-text/80 text-lg mb-8">
                            The Senior Secondary years at MP Kids School are designed to provide students with
