...
export default async function PrePrimaryPage() {
    ...
    const pageData = await StaticPage.findOne({
        slug: "academics-pre-primary",
        schoolIds: schoolId
    }).lean();

    const content = {
        title: pageData?.title || "Pre-Primary Wing",
        subtitle: pageData?.subtitle || "Nurturing curiosity and social skills through play-based learning for our youngest learners (Playgroup to KG).",
        bannerImage: pageData?.bannerImage || "/images/pre-primary-hero.jpg"
    };
                ...
                {pageData?.sections && pageData.sections.length > 0 ? (
                    ...
                    <>
                        ...
                        <p className="text-text/80 text-lg mb-8">
                            ...
                            At MP Kids School, we follow a unique **Play-Way and Montessori-inspired pedagogy** that encourages
