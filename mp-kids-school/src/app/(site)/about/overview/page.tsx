...
export const metadata = {
    title: "Overview | About Us | MP Kids School",
    description: "Learn about the history, identity, and core focus areas of MP Kids School. Over 25 years of academic excellence.",
};
...
export default async function AboutOverviewPage() {
    ...
    const banner = {
        ...
        description: pageData?.description || "Founded in 1995, MP Kids School has been a beacon of quality education, blending traditional values with modern innovation.",
                    ...
                    <div className="space-y-12">
                        <section>
                            ...
                            <p className="text-slate-600 leading-relaxed text-lg mb-8 italic">
                                MP Kids School is more than just a school; it is a community dedicated to the holistic development of every child. We believe in nurturing curious minds and compassionate hearts through a curriculum that challenges and inspires.
                            </p>
