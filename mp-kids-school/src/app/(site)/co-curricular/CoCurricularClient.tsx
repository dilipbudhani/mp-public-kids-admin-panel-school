...
export function CoCurricularClient({ pageData }: CoCurricularClientProps) {
    ...
    const [formData, setFormData] = useState({ name: '', class: '', activity: '' });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setSubmitted(true);
        setTimeout(() => setSubmitted(false), 3000);
        setFormData({ name: '', class: '', activity: '' });
    };
    ...
    return (
        <div className="min-h-screen bg-surface">
            {/* 1. Hero Section */}
            <section className="relative h-[450px] flex items-center bg-primary overflow-hidden pt-32 pb-16">
