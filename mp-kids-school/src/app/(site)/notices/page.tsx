...
export const metadata: Metadata = {
    title: 'School Notices | MP Kids School',
    description: 'Stay updated with the latest official announcements, circulars, and events from MP Kids School.',
};
        ...
        <main className="min-h-screen bg-surface">
            <PageHeader
                ...
                breadcrumb={[
                    { label: "Home", href: "/" },
                    { label: "Updates", href: "#" },
                    { label: "Notices", href: "/notices", active: true }
                ]}
                dark={true}
            />
