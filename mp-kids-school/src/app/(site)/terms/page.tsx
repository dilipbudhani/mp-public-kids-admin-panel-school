...
export default function TermsOfUsePage() {
    return (
        <UtilityPageLayout
            ...
            description="The terms and conditions governing the use of the MP Kids School digital platform and services."
            icon="file-text"
        >
            <div className="space-y-8">
                ...
                <section>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                        Permission is granted to temporarily download one copy of the materials (information or software) on MP Kids School's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                    </p>
                ...
                <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        Any claim relating to MP Kids School's website shall be governed by the laws of India, specifically under the jurisdiction of the courts in New Delhi, without regard to its conflict of law provisions.
                    </p>
                </section>
