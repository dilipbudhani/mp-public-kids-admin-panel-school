...
export const metadata = {
    title: "Sports Excellence | MP Kids School",
    description: "Explore the world-class sports infrastructure at MP Kids School where we foster discipline, teamwork, and resilience in every student.",
};
...
export default async function SportsFacilitiesPage() {
    ...
    const pageData = await StaticPage.findOne({ slug: "facilities-sports" }).lean() as IStaticPage | null;
            ...
            <div className="prose prose-slate max-w-none">
                ...
                {pageData?.content?.[0] ? (
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        MP Kids School offers world-class sports infrastructure that caters to a wide variety of indoor and outdoor activities. Our professional coaching staff ensures that students can pursue their passion for sports at competitive levels.
                    </p>
                )}
