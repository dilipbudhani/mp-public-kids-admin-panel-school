...
export const metadata = {
    title: "Safe Transportation | MP Kids School",
            ...
            <div className="prose prose-slate max-w-none">
                ...
                {pageData?.content?.[0] ? (
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        MP Kids School provides a robust transportation network with a fleet of well-maintained buses. Each bus is equipped with advanced safety features and is manned by trained staff to ensure the safety of every child.
                    </p>
                )}
                ...
                <div className="bg-primary/5 border border-primary/10 rounded-2xl p-8 text-center not-prose">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <div className="flex items-center gap-2 text-primary font-bold">
                            <Mail className="w-4 h-4 text-secondary" /> transport@mppublicschool.edu.in
                        </div>
                    </div>
                </div>
            </div>
